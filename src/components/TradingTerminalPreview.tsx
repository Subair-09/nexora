    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <div className={`border-b px-4 py-3 flex flex-wrap items-center justify-between gap-3 text-xs ${
            ...
            <div className="flex items-center gap-3">
              <div className="flex items-center gap-2">
                ...
                <span className={`font-mono font-bold uppercase tracking-wider ${
                  ...
                  NEXORA SIMULATOR v5.2
                </span>
              </div>

              {/* Trader Level Pill */}
              <div className={`hidden sm:flex items-center gap-1.5 px-2.5 py-1 rounded-full border text-[10px] font-mono font-bold ${
            ...
            <div className="flex items-center gap-4 font-mono text-xs">
              <div>
                <span className={`text-[10px] uppercase block ${isLight ? 'text-slate-400' : 'text-gray-500'}`}>Demo Cash</span>
              ...
              <div className="hidden md:block">
                <span className={`text-[10px] uppercase block ${isLight ? 'text-slate-400' : 'text-gray-500'}`}>Total Equity</span>
                <span className={`font-bold ${equity >= balance ? (isLight ? 'text-emerald-700' : 'text-emerald-400') : (isLight ? 'text-rose-700' : 'text-rose-400')}`}>
              ...
              <div className="hidden lg:block">
                ...
                <span className={`font-bold ${unrealizedPnl >= 0 ? (isLight ? 'text-emerald-700' : 'text-emerald-400') : (isLight ? 'text-rose-700' : 'text-rose-400')}`}>
            ...
            <div className="flex items-center gap-2 font-mono">
              <button
                ...
                className="px-3 py-1.5 rounded-lg bg-emerald-600 hover:bg-emerald-500 active:scale-95 text-white font-bold text-xs flex items-center gap-1.5 transition-all shadow-sm shadow-emerald-600/20"
              >
              ...
              <button
                ...
                className="px-3 py-1.5 rounded-lg bg-amber-500 hover:bg-amber-400 active:scale-95 text-slate-950 font-bold text-xs flex items-center gap-1.5 transition-all shadow-sm shadow-amber-500/20"
              >
              ...
              >
                {stats.soundEnabled ? <Volume2 className="w-4 h-4 text-blue-500" /> : <VolumeX className="w-4 h-4" />}
              </button>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 min-h-[600px]">
            ...
            <div className={`lg:col-span-2 border-r p-3 flex flex-row lg:flex-col justify-between overflow-x-auto lg:overflow-visible ${
                ...
                {sidebarTabs.map((tab) => {
                  ...
                  return (
                    <button
                      ...
                      className={`flex items-center justify-between px-3 py-2 text-xs font-medium rounded-lg transition-colors whitespace-nowrap text-left ${
                        isActive
                    ...
                    >
                      <div className="flex items-center gap-2">
                        <Icon className={`w-4 h-4 ${isActive ? 'text-white' : isLight ? 'text-slate-500' : 'text-gray-400'}`} />
                        <span>{tab.label}</span>
                      </div>
                      {tab.count !== null && (
